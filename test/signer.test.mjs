...
test('accepts the connected Base Account while preserving deployment locks', () => {
  assert.doesNotMatch(html, /account!==EXPECTED/);
  assert.doesNotMatch(html, /Wrong wallet connected/);
